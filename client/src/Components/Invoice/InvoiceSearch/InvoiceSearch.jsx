       ...
       <InvoiceCreate></InvoiceCreate>
            ...
            <Row gutter={16} style={{ marginTop: "10px" }}>
                <Col span={6}>
                    ...
                    <DatePicker placeholder={"Select Date from"} style={{ width: "100%" }} onChange={onChange} />
                ...
                <Col span={6}>
                    ...
                    <DatePicker placeholder={"Select Date To"} style={{ width: "100%" }} onChange={onChange} />
                ...
                <Col span={6}>
                    ...
                    <Button style={{ width: "100%" }} ghost type="primary" icon={<SearchOutlined />}>
                        Search
                    </Button>
